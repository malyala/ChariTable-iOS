...
class ListTableViewController: UITableViewController {
    ...
    var lists: [List] = [
        List(name: "DC Metro Area", items: []),
        List(name: "Greater Boston Area", items: [
            Item(title: "Sleeping bag (moreconvenient@yahoo)", description: "Item with a description"),
            Item(title: "Winter clothes (thananother@hotmail)", description: "Item with a description"),
            Item(title: "Bread (messaginginterface@gmail)", description: nil),
            Item(title: "Water (tocheck@hotmail)", description: nil)
        ]),
    ]
